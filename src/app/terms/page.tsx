...
export default function Terms() {
  return (
    <section aria-labelledby="tos-title" className="max-w-6xl mx-auto px-4 py-8 space-y-5">
      <h1 className="border-b pb-3" id="tos-title">
        Terms and Conditions
      </h1>

      <p>
        These terms and conditions outline the rules and regulations for the use of JobMatch Co's
        Website, located at JobMatch.com.
      </p>

      <p>
        By accessing this website we assume you accept these terms and conditions. Do not continue
        to use JobMatch if you do not agree to take all of the terms and conditions stated on this
        page.
      </p>
      ...
      <p>
        ...
        prevailing law of cn. Any use of the above terminology or other words in the singular,
      ...
      <p>
        We employ the use of cookies. By accessing JobMatch, you agreed to use cookies in agreement
        with the JobMatch Co's Privacy Policy.{' '}
      </p>
      ...
      <p>
        Unless otherwise stated, JobMatch Co and/or its licensors own the intellectual property
        rights for all material on JobMatch. All intellectual property rights are reserved. You may
        access this from JobMatch for your own personal use subjected to restrictions set in these
        terms and conditions.
      </p>

      <p>You must not:</p>
      <ul>
        <li>Republish material from JobMatch</li>
        <li>Sell, rent or sub-license material from JobMatch</li>
        <li>Reproduce, duplicate or copy material from JobMatch</li>
        <li>Redistribute content from JobMatch</li>
      </ul>
      <p>
        Parts of this website offer an opportunity for users to post and exchange opinions and
        information in certain areas of the website. JobMatch Co does not filter, edit, publish or
        review Comments prior to their presence on the website. Comments do not reflect the views
        and opinions of JobMatch Co,its agents and/or affiliates. Comments reflect the views and
        opinions of the person who post their views and opinions. To the extent permitted by
        applicable laws, JobMatch Co shall not be liable for the Comments or for any liability,
        damages or expenses caused and/or suffered as a result of any use of and/or posting of
        and/or appearance of the Comments on this website.
      </p>

      <p>
        JobMatch Co reserves the right to monitor all Comments and to remove any Comments which can
      ...
      <p>
        You hereby grant JobMatch Co a non-exclusive license to use, reproduce, edit and authorize
      ...
      <p>
        ...
        visibility of the hyperlink compensates the absence of JobMatch Co; and (d) the link is in
      ...
      <p>
        ...
        linking to our website, you must inform us by sending an e-mail to JobMatch Co. Please
      ...
      <p>
        No use of JobMatch Co's logo or other artwork will be allowed for linking absent a trademark
        license agreement.
      </p>
